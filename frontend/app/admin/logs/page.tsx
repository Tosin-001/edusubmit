...
const ACTION_LABELS: Record<string, string> = {
  ...
  "subject.restored": "Subject restored",
  ...
  "teacher_assignment.created": "Teacher assigned",
  "teacher_assignment.updated": "Teacher assignment updated",
  "teacher_assignment.deleted": "Teacher assignment removed",
...
const FILTER_ACTIONS = [
  ...
  { value: "teacher_assignment.created", label: "Teacher assigned" },
